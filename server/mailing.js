...
async function mailLeadToAdmin(userData) {
  ...
  let info = await transporter
    .sendMail({
      ...
      html: `<h1>Hey !</h1> <p>${userData.complete_name} wants to be contacted. </p><p>The email is ${userData.email} and the phone number is ${userData.phone_number}. </p><p>Name of the shop is ${userData.shop_name}, from the country ${userData.country}. </p><p>Message box did contain the following: <i>" ${userData.message}.</i>"</p><p>Let's go !</p>`, // html body
    })
